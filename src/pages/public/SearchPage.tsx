...
import type { Property } from "@/components/property-cards/PropertyCardWide";
...
const mockResults: Property[] = [
  {
    ...
    managedBy: "Managed by a private host",
    locationLine: "Anaxos · Show on map",
    distanceLine: "0.6 km from downtown · Beach Nearby",
    highlights: ["400 m from beach"],
    roomTitle: "Two-Bedroom Apartment",
    roomMeta:
      "Entire apartment · 2 bedrooms · 1 living room · 1 bathroom · 75 m²",
    ratingLabel: "Exceptional",
    ratingScore: 9.6,
    reviewsCount: 8,
    locationScoreLabel: "Location",
    locationScore: 9.7,
    nightsLabel: "1 night, 2 adults",
    price: 85,
    taxesLine: "Includes taxes and fees",
    cta: "See availability",
  },
  {
    id: "2",
    name: "Georgia's beach house",
    image:
      "https://images.unsplash.com/photo-1523217582562-09d0def993a6?auto=format&fit=crop&w=1200&q=80",
    managedBy: "Managed by a private host",
    locationLine: "Anaxos · Show on map",
    distanceLine: "0.6 km from downtown",
    highlights: ["Beachfront"],
    roomTitle: "One-Bedroom House",
    roomMeta: "Entire vacation home · 1 bedroom · 1 bathroom · 25 m²",
  ...
  {
    id: "4",
    name: "Georgia's beach house (Copy)",
    image:
      "https://images.unsplash.com/photo-1523217582562-09d0def993a6?auto=format&fit=crop&w=1200&q=80",
    managedBy: "Managed by a private host",
    locationLine: "Anaxos · Show on map",
...
const SearchPage = () => {
  ...
  const destination = params.get("destination") || "Anaxos";
  const dates = params.get("dates") || "Sat, Dec 27 — Sun, Dec 28";
  const guests = params.get("guests") || "2 adults · 0 children · 1 room";
  ...
  const results = useMemo(() => {
    return mockResults;
  }, [sortBy, budget, popularFilters, destination, dates, guests]);
      ...
      <div className="mt-4 grid grid-cols-1 lg:grid-cols-[320px_1fr] gap-6">
        ...
        <section>
          ...
          <div className="mt-5 space-y-5">
            {results.map((p, idx) => (
              <PropertyCardWide property={p} idx={idx} />
            ))}
          </div>
        </section>
      </div>
